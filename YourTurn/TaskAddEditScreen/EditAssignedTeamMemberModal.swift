...
class EditAssignedTeamMemberModal: ModalViewController {
    ...
    func configureModal() {
        ...
        teamMembersTableView.anchor(top: titleLabel.bottomAnchor, left: subView.leftAnchor, bottom: closeButton.topAnchor, right: subView.rightAnchor)
...
extension EditAssignedTeamMemberModal: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let teamMembersArray = viewModel?.teamMembers {
            cell.nameLabelString = teamMembersArray[indexPath.row].username
        }
        return cell
    }
}
